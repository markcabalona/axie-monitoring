...
(function dartProgram() {
  ...
  var A = {
    ...
    _LinkedHashSet: function _LinkedHashSet(t0) {
      var _ = this;
      _._collection$_length = 0;
      _._collection$_last = _._first = _._collection$_rest = _._nums = _._strings = null;
      _._modifications = 0;
      _.$ti = t0;
    },
    ...
    JsObject_JsObject($constructor, $arguments) {
      var args, t1, factoryFunction,
        ctor = A._convertToJS($constructor);
      if ($arguments == null)
        return A._wrapToDart(new ctor());
      if ($arguments instanceof Array)
        switch ($arguments.length) {
          case 0:
            return A._wrapToDart(new ctor());
          case 1:
            return A._wrapToDart(new ctor(A._convertToJS($arguments[0])));
          case 2:
            return A._wrapToDart(new ctor(A._convertToJS($arguments[0]), A._convertToJS($arguments[1])));
          case 3:
            return A._wrapToDart(new ctor(A._convertToJS($arguments[0]), A._convertToJS($arguments[1]), A._convertToJS($arguments[2])));
          case 4:
            return A._wrapToDart(new ctor(A._convertToJS($arguments[0]), A._convertToJS($arguments[1]), A._convertToJS($arguments[2]), A._convertToJS($arguments[3])));
        }
      args = [null];
      t1 = A._arrayInstanceType($arguments);
      B.JSArray_methods.addAll$1(args, new A.MappedListIterable($arguments, t1._eval$1("Object?(1)")._as(A.js___convertToJS$closure()), t1._eval$1("MappedListIterable<1,Object?>")));
      factoryFunction = ctor.bind.apply(ctor, args);
      String(factoryFunction);
      return A._wrapToDart(new factoryFunction());
    },
    JsArray_JsArray$from(other, $E) {
      var t1 = [];
      B.JSArray_methods.addAll$1(t1, J.map$1$1$ax(other, A.js___convertToJS$closure(), type$.dynamic));
      return new A.JsArray(t1, $E._eval$1("JsArray<0>"));
    },
    _castToJsObject(o) {
      return o;
    },
    ...
    initSqlJs() {
      ...
      if (t1 != null)
        return t1.future;
      $._moduleCompleter = new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_SqlJsModule), type$._AsyncCompleter_SqlJsModule);
      t1 = $.$get$_context();
      if (!("initSqlJs" in t1._jsObject))
        return A.Future_Future$error(new A.UnsupportedError("Could not access the sql.js javascript library. The drift documentation contains instructions on how to setup drift the web, which might help you fix this."), null, type$.SqlJsModule);
      type$.JsObject._as(t1.callMethod$1("initSqlJs")).callMethod$2("then", [A.sql_js___handleModuleResolved$closure()]);
      return $._moduleCompleter.future;
    },
    _handleModuleResolved(module) {
      var t1 = $._moduleCompleter;
      t1.toString;
      t1.complete$1(0, new A.SqlJsModule(type$.JsObject._as(module)));
    },
  ...
  A._LinkedHashSet.prototype = {
    ...
    _newLinkedCell$1(element) {
      ...
      if (_this._first == null)
        _this._first = _this._collection$_last = cell;
      else {
        t1 = _this._collection$_last;
        t1.toString;
        cell._previous = t1;
        _this._collection$_last = t1._next = cell;
      }
      ++_this._collection$_length;
      _this._modified$0();
      return cell;
  ...
  A.DriftCommunication.prototype = {
    _handleMessage$1(msg) {
      ...
      if (msg instanceof A.SuccessResponse) {
        ...
        completer = t1.$index(0, t2);
        if (completer != null)
          completer.completeError$2(msg.error, new A._StringStackTrace(msg.stackTrace));
        t1.remove$1(0, t2);
        ...
        if (completer != null)
          completer.completeError$1(B.C_CancellationException);
      }
    },
    request$1$1(_, request, $T) {
      var t1 = this._currentRequestId++,
        t2 = new A._Future($.Zone__current, $T._eval$1("_Future<0>"));
      this._pendingRequests.$indexSet(0, t1, new A._AsyncCompleter(t2, $T._eval$1("_AsyncCompleter<0>")));
  ...
  A.DriftProtocol.prototype = {
    ...
    deserialize$1(message) {
      ...
      switch (tag) {
        ...
        case 2:
          return new A.ErrorResponse(id, type$.Object._as(t1.$index(message, 2)), A._asString(t1.$index(message, 3)));
        case 1:
      ...
      if (payload instanceof A.NoArgsRequest)
        ...
        if (t1.get$isEmpty(rows))
          ...
          for (t1 = t1.get$iterator(rows); t1.moveNext$0();)
            B.JSArray_methods.addAll$1(result, J.get$values$x(t1.get$current()));
          return result;
        }
    ...
    decodePayload$1(encoded) {
      ...
      switch (tag) {
        ...
        case 3:
          ...
          t1.toString;
          return new A.ExecuteQuery(method, A._asString(J.$index$asx(t1, 2)), type$.List_dynamic._as(J.$index$asx(_box_0.fullMessage, 3)), readNullableInt.call$1(4));
        case 4:
          t1.toString;
  ...
  A.ServerImplementation.prototype = {
    serve$1(channel) {
      ...
      comm = new A.DriftCommunication(channel, true, t2, A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.Completer_dynamic), A.StreamController_StreamController(null, null, true, type$.Request_2));
    ...
    _handleRequest$2(comms, request) {
      ...
      if (payload instanceof A.NoArgsRequest)
        ...
        for (t1 = _this._activeChannels, t1 = A._LinkedHashSetIterator$(t1, t1._modifications, t1.$ti._precomputed1), t2 = t1.$ti._precomputed1, t3 = type$.dynamic; t1.moveNext$0();)
  ...
  A.TableUpdate.prototype = {
    get$hashCode(_) {
      return A.Object_hash(this.kind, this.table);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.BatchedStatements.prototype = {
    get$hashCode(_) {
      return A.Object_hash(B.C_ListEquality.hash$1(0, this.statements), B.C_ListEquality.hash$1(0, this.$arguments));
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.ArgumentsForBatchedStatement.prototype = {
    get$hashCode(_) {
      return A.Object_hash(this.statementIndex, B.C_ListEquality);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.SqlJsModule.prototype = {
    _createInternally$1(data) {
      ...
      if (data != null)
        return A.JsObject_JsObject($constructor, [data]);
      else
        return A.JsObject_JsObject($constructor, null);
    }
  };
  A.SqlJsDatabase.prototype = {
    prepare$1(sql) {
      return new A.PreparedStatement(type$.JsObject._as(this._obj.callMethod$2("prepare", [sql])));
    },
    runWithArgs$2(sql, args) {
      this._obj.callMethod$2("run", [sql, A.JsArray_JsArray$from(args, type$.dynamic)]);
    },
  ...
  A._WebDelegate.prototype = {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(t1.restore$0(), $async$open$1);
            case 4:
              // returning from await.
    ...
    runBatched$1(statements) {
      var t2, t3, t4, t5, _i, application, t6, t7,
        t1 = A._setArrayType([], type$.JSArray_PreparedStatement);
      for (t2 = statements.statements, t3 = t2.$ti, t2 = new A.ListIterator(t2, t2.get$length(t2), t3._eval$1("ListIterator<ListMixin.E>")), t3 = t3._eval$1("ListMixin.E"), t4 = type$.JsObject; t2.moveNext$0();) {
        t5 = t3._as(t2.__internal$_current);
        t1.push(new A.PreparedStatement(t4._as(A._lateReadCheck(this.___WebDelegate__db, "_db")._obj.callMethod$2("prepare", [t5]))));
      }
      for (t2 = statements.$arguments, t3 = t2.length, t4 = type$.dynamic, t5 = type$.JsArray_dynamic, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        application = t2[_i];
        ...
        t6 = t1[t6]._obj;
        t7 = [];
        B.JSArray_methods.addAll$1(t7, B.JSArray_methods.map$1$1(application.$arguments, A.js___convertToJS$closure(), t4));
        t6.callMethod$2("bind", [new A.JsArray(t7, t5)]);
        A._asBool(t6.callMethod$1("step"));
      }
    ...
    runSelect$2(statement, args) {
      var rows, t2, columnNames, t3,
        t1 = A._lateReadCheck(this.___WebDelegate__db, "_db").prepare$1(statement)._obj;
      t1.callMethod$2("bind", [A.JsArray_JsArray$from(args, type$.dynamic)]);
      rows = A._setArrayType([], type$.JSArray_List_dynamic);
      for (t2 = type$.JsArray_dynamic, columnNames = null; A._asBool(t1.callMethod$1("step"));) {
        if (columnNames == null) {
          t3 = t2._as(t1.callMethod$1("getColumnNames"));
          columnNames = new A.CastList(t3, t3.$ti._eval$1("CastList<ListMixin.E,String>"));
        }
        B.JSArray_methods.add$1(rows, t2._as(t1.callMethod$1("get")));
      }
      if (columnNames == null)
      ...
      var $async$_handlePotentialUpdate$0 = A._wrapJsFunctionForAsync(function ($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              modified = A._asInt(A._lateReadCheck($async$self.___WebDelegate__db, "_db")._obj.callMethod$1("getRowsModified"));
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              // then
              $async$goto = 4;
              return A._asyncAwait($async$self.storage.store$1(type$.Uint8List._as(A._lateReadCheck($async$self.___WebDelegate__db, "_db")._obj.callMethod$1("export"))), $async$_storeDb$0);
            case 4:
            // returning from await.
            case 3:
              // join
      ...
      var $async$setSchemaVersion$1 = A._wrapJsFunctionForAsync(function ($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A._lateReadCheck($async$self.delegate.___WebDelegate__db, "_db")._obj.callMethod$2("run", ["PRAGMA user_version = " + version]);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 57, 0);
    ...
    _static_1(A, "async___printToZone$closure", "_printToZone", 62);
    ...
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 64);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 43);
    _instance_1_u(A.DriftCommunication.prototype, "get$_handleMessage", "_handleMessage$1", 3);
    _static_1(A, "sql_js___handleModuleResolved$closure", "_handleModuleResolved", 1);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.EventTarget, [A.Node, A.FileReader, A.MessagePort, A.WorkerGlobalScope, A.Window, A.Database, A.Request0, A.Transaction]);
